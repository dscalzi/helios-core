...
import { AuthorizationTokenResponse, AuthTokenRequest, MCInfoState, MCTokenResponse, MCUserInfo, MicrosoftAuth, RefreshTokenRequest, XboxServiceTokenResponse } from '../../../../lib/auth/provider/microsoft/MicrosoftAuth'
import { URL } from 'url'
